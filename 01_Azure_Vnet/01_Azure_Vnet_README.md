...
> Module 1 of the [Azure_Terraform_Services](../README.md) series. Downstream modules (Key Vault, MySQL, App Service) assume this has been deployed first — they look up the RG, VNet, subnets, and DNS zones it creates via data sources. This module also runs standalone if you just want a clean segmented VNet.
